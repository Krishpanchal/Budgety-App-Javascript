...
var budgetController = (function () {
  ...
  return {
    addItem: function (type, des, val) {
      ...
      //Creating new ID for type - inc or exp
      ...
      // Adding the newItem into data structure
    ...
    calculatebudget: function(){
      ...
      // Calculates the totals of income amd expense
        calculateTotal("inc");
        calculateTotal("exp");
